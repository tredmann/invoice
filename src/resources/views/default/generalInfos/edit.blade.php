...
@section('content')
    ...
    <section id="content_section" class="mt-5 box pb-1 p-0">
        ...
        <form id="content_form" class="p-4" method="POST" action="{{$tenant->route('generalInfos.update', ['generalInfo' => $generalInfo])}}">
        @csrf
        @method('PATCH')
            ...
            <div class="field">
                ...
                <div class="control">
                    <input id="name" name="name" type="text"
                           class="input"
                           value="{{old('name') ?? $generalInfo->name}}"
                           required>
                </div>
            </div>
            ...
            <div class="field">
                ...
                <div class="control">
                    <input id="owner" name="owner" type="text"
                           class="input"
                           value="{{old('owner') ?? $generalInfo->owner}}"
                           required>
                </div>
            </div>
            ...
            <div class="field">
                ...
                <div class="control">
                    <input id="additional_address" name="additional_address" type="text"
                           class="input"
                           value="{{old('additional_address') ?? $generalInfo->additional_address}}"
            ...
            <div class="field">
                ...
                <div class="control">
                    <input id="street" name="street" type="text"
                           class="input"
                           value="{{old('street') ?? $generalInfo->street}}"
                           required>
                </div>
            </div>
            ...
            <div class="field">
                ...
                <div class="control">
                    <input id="postal" name="postal" type="text"
                           class="input"
                           value="{{old('postal') ?? $generalInfo->postal}}"
                           required>
                </div>
            </div>
            ...
            <div class="field">
                ...
                <div class="control">
                    <input id="city" name="city" type="text"
                           class="input"
                           value="{{old('city') ?? $generalInfo->city}}"
                           required>
                </div>
            </div>
                    ...
                    <div class="select is-fullwidth">
                        <select id="country" name="country" required>
                            @foreach(\App\Models\Tenant\GeneralInfo::COUNTRIES as $country)
                                <option
                                    @if(old('country') ? old('country') === $country : $country === $generalInfo->country) selected @endif>{{$country}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
            ...
            <div class="field">
                ...
                <div class="control">
                    <input id="homepage" name="homepage" type="url"
                           class="input"
                           value="{{old('homepage') ?? $generalInfo->homepage}}"
                           required>
                </div>
            </div>
